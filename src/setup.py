...
# Rename 'CATHe Dataset' to 'Dataset' if 'Dataset' does not already exist
...
# Move the CATHe.h5 file to the correct location
...
# If the user says yes, download 'prot_t5_xl_uniref50.zip' using requests with a progress bar
if user_input == 'y':
...
# Change back to the root (4 levels up)
