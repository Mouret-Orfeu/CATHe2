#code from https://github.com/mheinzinger/ProstT5/blob/main/scripts/predict_3Di_encoderOnly.py
# takes input:FASTA(AA) to output:FASTA(3Di) using a CNN trained on top of embeddings from ProstT5's Encoder:
# run ```python predict_3Di_encoderOnly.py --input /path/to/some_AA_sequences.fasta --output /path/to/some_3Di_sequences.fasta --half 1 ```
