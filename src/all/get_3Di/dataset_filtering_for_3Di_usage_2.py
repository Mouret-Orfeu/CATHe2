...
def save_dataset_ids_for_3Di_usage_in_classification(pLDDT_threshold, train_sf_0):
    ...
    val_filtered_ids, test_filtered_ids = remove_lost_and_unrepresented_sf(train_sf_0, threshold_sf, Val_domain_ids_for_which_I_have_3Di, Test_domain_ids_for_which_I_have_3Di, csv_val, csv_test)
...
def main():
    ...
    for pLDDT_threshold in [0, 4, 14, 24, 34, 44, 54, 64, 74, 84]:
        save_dataset_ids_for_3Di_usage_in_classification(pLDDT_threshold, train_sf_0)
