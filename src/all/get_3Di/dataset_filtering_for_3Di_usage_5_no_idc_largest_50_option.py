...
def save_SF_lost_csv(pLDDT_threshold, total_lost_SF, nb_SF_remaining, Training_set_size, top_50_filtering):
    ...
    if os.path.exists(lost_SF_csv_path):
        ...
        condition = (df['pLDDT_threshold'] == pLDDT_threshold) & (df['Top_50_filtering'] == top_50_filtering)
...
def save_dataset_ids_for_3Di_usage_in_classification(pLDDT_threshold, top_50_filtering):
    ...
    # Compute the Train Domain_ids of the 50 largest SF (if option is enabled)
    if top_50_filtering:
    ...
    if top_50_filtering:
        Train_csv_path = f'./data/Dataset/csv/Train_ids_for_3Di_usage_{pLDDT_threshold}_top_50_SF.csv'
    else:
        Train_csv_path = f'./data/Dataset/csv/Train_ids_for_3Di_usage_{pLDDT_threshold}.csv'
    ...
    save_SF_lost_csv(pLDDT_threshold, total_lost_SF, nb_SF_remaining, Training_set_size, top_50_filtering)
    ...
    if top_50_filtering:
        Test_csv_path = f'./data/Dataset/csv/Test_ids_for_3Di_usage_{pLDDT_threshold}_top_50_SF.csv'
        Val_csv_path = f'./data/Dataset/csv/Val_ids_for_3Di_usage_{pLDDT_threshold}_top_50_SF.csv'
    else:
        Test_csv_path = f'./data/Dataset/csv/Test_ids_for_3Di_usage_{pLDDT_threshold}.csv'
        Val_csv_path = f'./data/Dataset/csv/Val_ids_for_3Di_usage_{pLDDT_threshold}.csv'
